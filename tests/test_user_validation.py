...
class TestValidate(UserValidationTest):
...
class TestValidateEmptyValues(Test):
...
class TestValidateEmptyValue(UserValidationTest):
...
class TestValidateUniqueValues(UserValidationTest):
